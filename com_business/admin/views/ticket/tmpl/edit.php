...
<form
	...
	method="post" enctype="multipart/form-data" name="adminForm" id="ticket-form" class="form-validate form-horizontal">
	...
	<?php echo JHtml::_('bootstrap.startTabSet', 'myTab', array('active' => 'ticket')); ?>
	<?php echo JHtml::_('bootstrap.addTab', 'myTab', 'ticket', JText::_('COM_BUSINESS_TAB_TICKET', true)); ?>
	<div class="row-fluid">
		<div class="span10 form-horizontal">
			<fieldset class="adminform">
				<legend><?php echo JText::_('COM_BUSINESS_FIELDSET_TICKET'); ?></legend>
