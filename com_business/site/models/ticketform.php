 ...
 * @since  1.6
 */
class BusinessModelTicketForm extends \Joomla\CMS\MVC\Model\FormModel
{
    private $item = null;
    ...
    {
        // Get the form.
        $form = $this->loadForm('com_business.ticket', 'ticketform', array(
                        'control'   => 'jform',
                        'load_data' => $loadData
                )
        );
    ...
    {
        $id    = (!empty($data['id'])) ? $data['id'] : (int) $this->getState('ticket.id');
