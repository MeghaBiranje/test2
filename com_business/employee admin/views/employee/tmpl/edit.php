...
<form
	...
	<?php echo JHtml::_('bootstrap.startTabSet', 'myTab', array('active' => 'employee')); ?>
	<?php echo JHtml::_('bootstrap.addTab', 'myTab', 'employee', JText::_('COM_BUSINESS_TAB_EMPLOYEE', true)); ?>
	<div class="row-fluid">
		<div class="span10 form-horizontal">
			<fieldset class="adminform">
				<legend><?php echo JText::_('COM_BUSINESS_FIELDSET_EMPLOYEE'); ?></legend>
