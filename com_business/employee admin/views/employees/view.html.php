 ...
 * @since  1.6
 */
class BusinessViewEmployees extends \Joomla\CMS\MVC\View\HtmlView
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		BusinessHelper::addSubmenu('employees');
	...
	protected function addToolbar()
	{
		...
		$title = JText::_('COM_BUSINESS_SUBMENU_EMPLOYEES');
		...
		JHtmlSidebar::setAction('index.php?option=com_business&view=employees');
	}
	...
	protected function getSortFields()
	{
		return array(
			...
			// 'a.`user_id`' => JText::_('COM_BUSINESS_EMPLOYEES_USER_ID'),
			'a.`title`' => JText::_('COM_BUSINESS_EMPLOYEES_NAME'),
			'a.`image`' => JText::_('COM_BUSINESS_EMPLOYEES_SURNAME'),
			'a.`category`' => JText::_('COM_BUSINESS_EMPLOYEES_EDUCATION'),
			'a.`priority`' => JText::_('COM_BUSINESS_EMPLOYEES_HOBBIES'),
			'a.`privacy`' => JText::_('COM_BUSINESS_EMPLOYEES_ADDRESS'),
		);
	}
