 ...
 * @since  1.6
 */
class BusinessModelEmployees extends \Joomla\CMS\MVC\Model\ListModel
{
...
/**
	...
	*/
	...
	protected function getListQuery()
	{
		...
		$query->from('`#__business_employees` AS a');
	...
	public function getItems()
	{
		...
		{
					$oneItem->category = JText::_('COM_BUSINESS_EMPLOYEES_CATEGORY_OPTION_' . strtoupper($oneItem->category));
		}
