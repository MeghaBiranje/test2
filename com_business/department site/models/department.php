 ...
 * @since  1.6
 */
class BusinessModelDepartment extends \Joomla\CMS\MVC\Model\ItemModel
{
    public $_item;
	...
	public function getItem($id = null)
	{
		...
		{
			$this->_item->priority = JText::_('COM_BUSINESS_DEPARTMENTS_PRIORITY_OPTION_' . $this->_item->priority);
		}
