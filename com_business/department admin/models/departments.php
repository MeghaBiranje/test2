 ...
 * @since  1.6
 */
class BusinessModelDepartments extends \Joomla\CMS\MVC\Model\ListModel
{
...
/**
	...
	*/
	...
	protected function getListQuery()
	{
		...
		$query->from('`#__business_departments` AS a');
		...
		if ($filter_priority !== null && (!empty($filter_priority)))
		{
	...
	public function getItems()
	{
		...
		{
					$oneItem->category = JText::_('COM_BUSINESS_DEPARTMENTS_CATEGORY_OPTION_' . strtoupper($oneItem->category));
		}
